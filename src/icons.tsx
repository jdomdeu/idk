...
export const PlusSquareO: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const MinusSquareO: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="64 -65 897 897">
    <g>
      <path
...
export const CloseSquareO: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="64 -65 897 897">
    <g>
      <path
